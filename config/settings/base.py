...
PHOTOROOM_MIN_SCENE_VARIANTS = env.int("PHOTOROOM_MIN_SCENE_VARIANTS", default=6)
PHOTOROOM_MIN_AI_SCENES = env.int("PHOTOROOM_MIN_AI_SCENES", default=4)
PHOTOROOM_MAX_AI_SCENES = env.int("PHOTOROOM_MAX_AI_SCENES", default=8)
...
PHOTOROOM_VIRTUAL_MODEL_PACK_SHOTS = env.int("PHOTOROOM_VIRTUAL_MODEL_PACK_SHOTS", default=3)
...
PHOTOROOM_PROFESSIONAL_MIN_SCENES = env.int("PHOTOROOM_PROFESSIONAL_MIN_SCENES", default=8)
