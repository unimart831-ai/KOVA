...
PHOTOROOM_VIRTUAL_MODEL_ENABLED = env.bool("PHOTOROOM_VIRTUAL_MODEL_ENABLED", default=True)
PHOTOROOM_VIRTUAL_MODEL_AUTO_PACK = env.bool("PHOTOROOM_VIRTUAL_MODEL_AUTO_PACK", default=True)
