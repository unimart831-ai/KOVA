...
ACCOUNT_SIGNUP_REDIRECT_URL = "/accounts/onboarding/start/"
...
PHOTOROOM_FEED_PORTRAIT_SIZE = env("PHOTOROOM_FEED_PORTRAIT_SIZE", default="1080x1350")
PHOTOROOM_FEED_PORTRAIT_ENABLED = env.bool("PHOTOROOM_FEED_PORTRAIT_ENABLED", default=True)
...
PHOTOROOM_PREFLIGHT_MAX_REPAIRS = env.int("PHOTOROOM_PREFLIGHT_MAX_REPAIRS", default=4)
...
# Studio polish — target 4 curated variants + original photo (5 gallery images)
STUDIO_POLISH_TARGET_VARIANTS = env.int("STUDIO_POLISH_TARGET_VARIANTS", default=5)
PHOTOROOM_MIN_SCENE_VARIANTS = env.int("PHOTOROOM_MIN_SCENE_VARIANTS", default=5)
PHOTOROOM_MIN_AI_SCENES = env.int("PHOTOROOM_MIN_AI_SCENES", default=3)
PHOTOROOM_MAX_AI_SCENES = env.int("PHOTOROOM_MAX_AI_SCENES", default=4)
...
PHOTOROOM_EDIT_WITH_AI_MAX_PER_PACK = env.int("PHOTOROOM_EDIT_WITH_AI_MAX_PER_PACK", default=4)
...
CAROUSEL_MAX_SLIDES = env.int("CAROUSEL_MAX_SLIDES", default=6)
...
PHOTOROOM_PHOTOFIX_ALWAYS = env.bool("PHOTOROOM_PHOTOFIX_ALWAYS", default=True)
PHOTOROOM_COMPOSITION_ENABLED = env.bool("PHOTOROOM_COMPOSITION_ENABLED", default=True)
PHOTOROOM_COMPOSITION_NATIVE = env.bool("PHOTOROOM_COMPOSITION_NATIVE", default=True)
PHOTOROOM_BEAUTIFY_NOCUTOUT_ENABLED = env.bool("PHOTOROOM_BEAUTIFY_NOCUTOUT_ENABLED", default=True)
PHOTOROOM_BASIC_PROBE_ENABLED = env.bool("PHOTOROOM_BASIC_PROBE_ENABLED", default=True)
PHOTOROOM_TRANSPARENT_CUTOUT_SAVE = env.bool("PHOTOROOM_TRANSPARENT_CUTOUT_SAVE", default=True)
PHOTOROOM_VIDEO_ENABLED = env.bool("PHOTOROOM_VIDEO_ENABLED", default=True)
...
PHOTOROOM_VIRTUAL_MODEL_AUTO_PACK = env.bool("PHOTOROOM_VIRTUAL_MODEL_AUTO_PACK", default=False)
PHOTOROOM_VIRTUAL_MODEL_PACK_SHOTS = env.int("PHOTOROOM_VIRTUAL_MODEL_PACK_SHOTS", default=1)
# Professional pipeline — maximize Photoroom Plus per upload (not MVP economics)
PHOTOROOM_PROFESSIONAL_MODE = env.bool("PHOTOROOM_PROFESSIONAL_MODE", default=True)
PHOTOROOM_PROFESSIONAL_SCENE_CAP = env.int("PHOTOROOM_PROFESSIONAL_SCENE_CAP", default=12)
PHOTOROOM_PROFESSIONAL_MIN_SCENES = env.int("PHOTOROOM_PROFESSIONAL_MIN_SCENES", default=4)
PHOTOROOM_QA_ENABLED = env.bool("PHOTOROOM_QA_ENABLED", default=True)
