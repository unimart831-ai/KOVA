...
def get_revenue_summary(user, days=30):
    ...
    from apps.create.briefs.asset_attribution import asset_type_breakdown, attribution_confidence_score
...
def get_revenue_headline_insight(user, days=7, summary=None):
    ...
    """
    from apps.insight.analytics.models import Conversion, WebsiteEvent
    ...
    if summary is not None:
        from apps.create.content.campaign_attribution import top_campaigns_by_revenue
...
def get_revenue_brief_data(user, days=7):
    ...
    from apps.create.content.campaign_attribution import campaign_revenue_brief_lines, top_campaigns_by_revenue
...
def record_touchpoint(user, visitor_id, touch_type, utm_source="", utm_medium="",
    ...
    """
    from apps.insight.analytics.models import ConversionJourney, ConversionTouchpoint
...
def complete_journey(user, visitor_id, conversion):
    ...
    """
    from apps.insight.analytics.models import ConversionJourney
