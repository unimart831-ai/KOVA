...
def insights(request):
    ...
    try:
        from apps.insight.analytics.plain_english import get_plain_english_insights
...
def competitor_add(request):
    ...
    if request.method == "POST":
        ...
        from apps.insight.analytics.tasks import analyze_competitor_task
...
def competitor_landscape(request):
    ...
    from apps.insight.analytics.competitor_intel import get_cached_landscape_report
...
def revenue_dashboard(request):
    ...
    from apps.insight.analytics.revenue import get_revenue_summary, get_revenue_headline_insight
...
def campaign_revenue_detail(request, campaign_id):
    ...
    from apps.create.content.campaign_attribution import get_campaign_performance_detail
...
def export_asset_breakdown_csv(request):
    ...
    from apps.create.briefs.asset_attribution import asset_type_breakdown
...
def shopify_connect(request):
    ...
    from apps.insight.analytics.models import ShopifyStore
    from apps.insight.analytics.shopify_oauth import normalize_shop_domain, shopify_configured
    from apps.core.billing.enforcement import check_shopify_integration, enforce_or_redirect
...
def shopify_oauth_begin(request):
    ...
    from apps.insight.analytics.shopify_oauth import (
        new_oauth_state,
...
def shopify_oauth_callback(request):
    ...
    from apps.core.billing.enforcement import check_shopify_integration, enforce_or_redirect
    from apps.commerce.products.shopify_import import sync_shopify_store_products
...
def download_report(request):
    ...
    from apps.insight.analytics.reports import generate_report_pdf
...
def screenshot_compete(request):
    ...
    from apps.insight.analytics.tasks import process_competitor_screenshot
