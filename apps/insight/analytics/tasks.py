...
def flush_pageview_buffer():
    ...
    from apps.insight.analytics.pageview_buffer import drain_pageview_buffer
    total = 0
    while True:
...
def analyze_competitor_task(user_id, competitor_id):
    ...
    from apps.insight.analytics.competitor_intel import analyze_competitor
    from apps.insight.analytics.models import Competitor
...
def _send_competitor_alerts(user, competitor, analysis):
    ...
    from apps.insight.analytics.models import CompetitorInsight
...
def process_competitor_screenshot(screenshot_id: str):
    ...
    """
    from django.utils import timezone
    from apps.insight.analytics.models import CompetitorScreenshot, Competitor
    from apps.create.content.models import ContentSeed
    ...
    try:
        ...
        from apps.create.agents.llm_router import call_llm_vision
        import json
...
def detect_top_performers():
    ...
    from apps.insight.analytics.models import PostMetric, PerformanceRecycle
...
def generate_recycle_email(recycle_id: str):
    ...
    try:
        ...
        from apps.create.agents.llm_router import call_llm
        import json
        ...
        from apps.messaging.emails.automation import auto_email_enabled, send_performance_recycle
