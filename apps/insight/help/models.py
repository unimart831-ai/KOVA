...
class Article(models.Model):
    ...
    ARTICLES registry in apps.insight.help.views; new entries are authored by the
    ...
    def save(self, *args, **kwargs):
        from apps.core.utils.html_sanitize import sanitize_html
...
class NewsletterSubscriber(models.Model):
    ...
    apps.messaging.emails.EmailSubscriber model which belongs to individual Kova users."""
