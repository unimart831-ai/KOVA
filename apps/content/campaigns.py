...
def ensure_campaign_for_seed(
    ...
    *,
    ...
    from apps.content.campaign_archive import default_campaign_expiry
    ...
    from apps.content.campaign_pages import ensure_campaign_commerce_url
...
def update_campaign_quality_from_posts(campaign) -> int | None:
    ...
    from apps.content.campaign_qa import refresh_campaign_qa
