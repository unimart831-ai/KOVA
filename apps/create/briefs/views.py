...
from apps.create.briefs.delivery import extract_your_move
from apps.create.briefs.standup import build_standup_context, enrich_decisions
...
def brief_home(request):
    ...
    from apps.create.briefs.decision_stream import build_decision_stream
    ...
    from apps.create.briefs.dashboard import get_cached_home_extras
...
def operations_report_partial(request):
    ...
    from apps.create.briefs.dashboard import get_cached_operations_report
