...
def handle_add_product(user, text: str) -> tuple[str, str, bool, dict]:
    ...
    from apps.commerce.products.owner_snap_whatsapp import _product_limit_message
...
def handle_plan(user) -> tuple[str, str, bool, dict]:
    ...
    from apps.create.briefs.calendar_hints import format_moments_whatsapp, upcoming_moments
    from apps.create.content.models import Post, WeeklyContentPlan
...
def handle_retry(user, text: str) -> tuple[str, str, bool, dict]:
    ...
    from apps.create.content.approval import republish_post_for_user
    from apps.create.content.models import Post
...
def handle_weekly(user) -> tuple[str, str, bool, dict]:
    from apps.create.briefs.weekly_report import format_weekly_smm_whatsapp
