...
from apps.create.agents.graphics import (
    CANVAS_SIZES,
    DEFAULT_CANVAS,
    GraphicType,
    _add_accent_bar,
...
def _show_carousel_counters() -> bool:
    try:
        from apps.create.content.carousel_studio import show_slide_counters
...
def generate_product_carousel(
    ...
    *,
    ...
    """
    from apps.create.content.carousel_studio import prepare_carousel_generation
