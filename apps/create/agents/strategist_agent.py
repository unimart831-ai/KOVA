...
def _gather_strategy_inputs(user):
    ...
    try:
        from apps.commerce.products.utils import get_product_strategy_context
    ...
    from apps.create.media.authority_packs import authority_seed_ideas_for_user
...
def _make_strategic_decisions(user, inputs):
    ...
    from apps.create.agents.memory import get_strategy_history, get_prediction_accuracy
