...
def run_daily_research():
    ...
    for idx, user in enumerate(users_with_research):
        from apps.core.billing.models import get_effective_plan_tier, get_plan_limits
...
def refresh_seed_suggestions(user_id):
    ...
    try:
        from apps.create.agents.playbooks import _get_ai_generated_suggestions
...
def _run_engage_for_user(user_id):
    ...
    from apps.create.agents.engage_agent import run_engage_cycle as engage_cycle
...
def run_adapt_cycle():
    ...
    Iterates eligible users and runs `apps.create.agents.adapt_agent.run_for_user`
    ...
    from apps.create.agents.adapt_agent import run_for_user  # noqa: F401  (import validates availability)
...
def _run_strategy_for_user(user_id):
    ...
    from apps.create.agents.strategist_agent import run_strategy_cycle as strategist_cycle
...
def measure_agent_outcomes():
    ...
    """
    from apps.create.agents.memory import (
...
def educator_draft_weekly_article():
    ...
    from apps.insight.help.models import ArticleTopic
    from apps.create.agents.educator_agent import draft_next_topic
...
def educator_compile_weekly_digest():
    ...
    from apps.create.agents.educator_agent import compile_weekly_digest
