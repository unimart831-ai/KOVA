...
from apps.create.content import views
...
urlpatterns = [
    ...
    path("studio/share/", views.share_moment, name="share_moment"),
    path("studio/share/submit/", views.share_moment_submit, name="share_moment_submit"),
    path("studio/shares/", views.share_list, name="share_list"),
    path("studio/shares/<uuid:seed_id>/", views.share_detail, name="share_detail"),
    path("studio/shares/<uuid:seed_id>/reschedule/", views.share_reschedule_bundle, name="share_reschedule_bundle"),
    path("studio/shares/<uuid:seed_id>/update/", views.share_update_context, name="share_update_context"),
