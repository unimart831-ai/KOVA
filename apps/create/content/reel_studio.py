...
def compose_professional_reel(
    ...
    *,
    ...
    """
    from apps.create.content.reel_director import ReelComposePlan
    from apps.create.content.reel_music import infer_mood_from_post, pick_music_track, resolve_track_path, ensure_audio_bed
    from apps.create.content.reel_frame_studio import brand_context_for_post
    from apps.create.content.video_compose import VideoComposeError, compose_from_plan, compose_motion_reel
