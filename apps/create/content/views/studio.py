...
from apps.create.content.forms import ContentSeedForm
...
def content_studio(request):
    ...
    from apps.core.billing.models import get_effective_plan_tier, get_user_plan_limits
    ...
    from apps.create.agents.playbooks import get_seed_suggestions
    ...
    from apps.commerce.products.asset_queries import studio_assets_for_user
...
def _enrich_seed_group(seed_obj, seed_posts, *, connected_platforms=None):
    ...
    from apps.create.content.campaigns import campaign_display_label
    from apps.create.content.campaign_pages import campaign_page_path
    from apps.create.content.campaign_bundle import bundle_display_for_studio
    from apps.create.content.campaign_approval import campaign_approval_summary
    from apps.create.content.campaign_qa import audit_campaign_qa, qa_display_for_studio
    from apps.create.content.campaign_attribution import campaign_revenue_snapshot
    from apps.create.content.post_labels import summarize_showcase_types
...
def share_moment_submit(request):
    ...
    if auto_mode:
        from apps.create.content.share_bundle import resolve_automated_share_options
    ...
    from apps.create.content.share_bundle import filter_accounts_for_share_items
