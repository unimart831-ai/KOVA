...
def clear_failed_posts(request):
    ...
    if request.headers.get("HX-Request") == "true":
        from apps.create.content.views.archive import _get_archive_context
...
def approve_post(request, post_id):
    ...
    from apps.create.content.scheduling import (
        get_next_best_slot,
    ...
    if post.seed_id:
        from apps.create.content.campaign_approval import sync_campaign_after_approval
