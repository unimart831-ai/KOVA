...
def prepare_campaign_media_factory(seed, campaign=None) -> dict[str, Any]:
    ...
    from apps.create.media.reel_strategy import build_reel_strategy
...
def _trigger_campaign_visual_production(seed, campaign, visual_brief) -> None:
    ...
    if product.uses_upload_images_only:
        return
    from apps.commerce.products.photo_variations import variation_storage_marker
...
def apply_reel_strategy_to_post(post, seed) -> None:
    ...
    from apps.create.media.reel_strategy import ReelStrategy, reel_strategy_to_compose_metadata
