...
The Remotion TypeScript project (`media_render/`) was removed; this module
returns None unless a future checkout restores that tree and
REEL_RENDER_BACKEND=remotion.
"""
