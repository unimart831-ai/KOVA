...
if TYPE_CHECKING:
    from apps.create.media.campaign_visual_brief import CampaignVisualBrief
    from apps.commerce.products.photoroom_api import PhotoroomEditResult
    from apps.commerce.products.photoroom_plus import PlusVariantSpec
...
def max_scenes_for_user(user) -> int:
    from apps.create.media.orchestrator import cap_photoroom_scenes_for_plan, professional_scene_cap
...
def variant_ids_from_brief(
    ...
    *,
    ...
    from apps.create.media.campaign_visual_brief import SCENE_ROLE_ALIASES
...
def qa_retry_params(variant_id: str, category: str) -> dict[str, str] | None:
    ...
    from apps.commerce.products.photoroom_api import beautify_mode_for_category, relight_mode_for
