...
from apps.messaging.emails.forms import EmailCampaignForm, EmailListForm, EmailSubscriberForm
...
def subscriber_add(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            from apps.messaging.emails.subscriber_sync import upsert_subscriber
...
def campaign_list(request):
    ...
    from apps.messaging.emails.automation import auto_email_enabled
...
def campaign_create(request):
    ...
    if request.method == "POST":
        ...
        if prompt:
            from apps.messaging.emails.automation import create_ai_campaign
        ...
        if form.is_valid():
            from apps.messaging.emails.automation import try_auto_send_campaign
            from apps.messaging.emails.subscriber_sync import ensure_default_list
...
def campaign_send(request, campaign_id):
    ...
    from apps.messaging.emails.tasks import send_campaign_task
...
def email_dashboard(request):
    ...
    from apps.messaging.emails.automation import auto_email_enabled, bootstrap_email_automation
