...
def ensure_welcome_sequence(user):
    ...
    """
    from apps.messaging.emails.models import EmailSequence, EmailSequenceStep
...
def enroll_existing_subscribers(sequence):
    ...
    from apps.messaging.emails.models import EmailSequenceStep, EmailSubscriber, SequenceEnrollment
...
def try_auto_send_campaign(campaign):
    ...
    from apps.messaging.emails.models import EmailCampaign, EmailSubscriber
