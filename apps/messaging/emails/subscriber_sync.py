...
def ensure_default_list(user):
    ...
    from apps.messaging.emails.models import EmailList
...
def upsert_subscriber(
    ...
    *,
    ...
    from apps.messaging.emails.models import EmailSubscriber
...
def _add_to_default_list(user, subscriber):
    ...
    from apps.messaging.emails.models import EmailList, EmailSubscriber
