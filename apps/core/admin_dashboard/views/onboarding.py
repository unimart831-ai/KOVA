...
from apps.create.agents.onboarding_tasks import STUCK_AFTER_SECONDS
...
def onboarding_funnel(request):
    ...
    from apps.core.accounts.setup_mission import get_onboarding_intent, is_commerce_industry
