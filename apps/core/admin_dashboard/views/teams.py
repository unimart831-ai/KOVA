...
def teams_overview(request):
    ...
    from apps.core.teams.models import Team, TeamActivity, TeamInvitation, TeamMember
    ...
    # Brands
    from apps.core.teams.models import Brand
...
def team_detail(request, pk):
    ...
    from apps.core.teams.models import Brand, Team, TeamActivity, TeamInvitation, TeamMember
