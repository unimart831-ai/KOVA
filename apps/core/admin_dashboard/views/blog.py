...
from apps.insight.help.models import Article, ArticleTopic
...
def blog_suggest_topics(request):
    ...
    from apps.create.agents.educator_agent import suggest_topics
...
def blog_draft_topic(request, pk):
    ...
    from apps.create.agents.educator_agent import draft_article
