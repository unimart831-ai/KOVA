...
def build_overview_context() -> dict:
    ...
    from apps.core.accounts.pilot_metrics import get_pilot_metrics
    from apps.core.admin_dashboard.ops_hub import get_cached_ops_hub_snapshot
    from apps.create.agents.models import AgentAction
    from apps.insight.analytics.models import Conversion, PageView, WebsiteEvent
    ...
    try:
        from apps.messaging.whatsapp.models import WhatsAppConversation, WhatsAppTemplate
    ...
    try:
        from apps.create.briefs.operations_report import build_platform_operations_report
