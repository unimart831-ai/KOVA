...
from apps.core.accounts.test_businesses import (
...
def compute_pilot_metrics(*, persist_snapshot: bool = False) -> dict:
    ...
    from apps.core.accounts.models import PilotMetricsSnapshot, User
...
def get_latest_snapshot() -> dict | None:
    from apps.core.accounts.models import PilotMetricsSnapshot
