...
from apps.core.accounts.phone_utils import apply_phone_to_user, is_valid_phone, normalize_phone
...
class UserSettingsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from apps.core.accounts.timezones import CURATED_TIMEZONES
...
class BrandProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "storefront_vibe" in self.fields:
            ...
            from apps.create.agents.engage_routing import is_level_allowed
    ...
    def clean_engage_autonomy_level(self):
        ...
        if not is_level_allowed(level, plan):
            ...
            from apps.create.agents.engage_routing import max_level_for_plan
    ...
    def clean_auto_approve_posts(self):
        ...
        from apps.core.billing.enforcement import check_auto_approve_plan
...
class AutopilotSettingsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        self.user = kwargs.pop("user", None)
        super().__init__(*args, **kwargs)
        from apps.core.accounts.autopilot_helpers import MAX_FAQ_ENTRIES
    ...
    def clean(self):
        cleaned = super().clean()
        from apps.core.accounts.autopilot_helpers import whatsapp_autopilot_allowed
        from django.forms import ValidationError
    ...
    def save(self, commit=True):
        from apps.core.accounts.autopilot_helpers import MAX_FAQ_ENTRIES, normalize_faq_answers
