...
from apps.core.partners.seller_provisioning import provision_marketplace_seller
from apps.commerce.products.marketplace_sync import apply_sync_images_to_product_data, trigger_marketplace_autopilot
...
def get_marketplace_partner(slug: str, *, create_if_missing: bool = False) -> MarketplacePartner:
    ...
    try:
        ...
        if not create_if_missing:
            raise
        from apps.core.partners.models import Partner, generate_api_key, hash_api_key, generate_referral_code
...
def provision_vendor_self_serve(
    ...
    *,
    ...
    if on_pending:
        ...
        from apps.core.partners.seller_provisioning import provision_result_to_response
