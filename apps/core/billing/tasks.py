...
def _try_recover_payment(payment, reason: str):
    ...
    from apps.core.billing.mpesa import query_stk_push
    from apps.core.billing.mpesa_services import activate_subscription
...
def check_mpesa_subscriptions():
    ...
    from apps.core.billing.models import MpesaPayment
    from apps.core.billing.mpesa_services import expire_subscription
    ...
    for profile in mpesa_profiles:
        ...
        if days_until_expiry < -3:
            ...
            from apps.core.billing.renewal_notifications import send_mpesa_renewal_warning
