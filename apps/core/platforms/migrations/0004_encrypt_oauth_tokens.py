...
2. Encrypts them using Fernet (via apps.core.platforms.encryption)
...
from apps.core.platforms.encryption import EncryptedTokenField


def encrypt_existing_tokens(apps, schema_editor):
    """Encrypt all existing plaintext tokens using Fernet."""
    from apps.core.platforms.encryption import encrypt_token
