...
class Command(BaseCommand):
    ...
    def _check_imports(self):
        ...
        modules = (
            "apps.content.blueprints",
            "apps.content.blueprint_pipeline",
            "apps.content.renderers",
            "apps.content.blueprint_retry",
            "apps.content.service_templates",
            "apps.content.professional_templates",
            "apps.content.professional_cta",
            "apps.briefs.revenue_summary",
            "apps.briefs.asset_attribution",
            "apps.accounts.product_voice",
            "apps.content.post_labels",
            "apps.leads.bridges",
            "apps.leads.professional_funnel",
            "apps.products.business_assets",
            "apps.products.professional_assets",
            "apps.media.brand_dna",
            "apps.media.asset_intelligence",
            "apps.media.router",
            "apps.media.orchestrator",
            "apps.bookings.service_setup",
            "apps.briefs.whatsapp_commands",
            "apps.content.approval",
        )
        for mod in modules:
            try:
                __import__(mod)
    ...
    def _check_blueprint_roundtrip(self):
        ...
        from apps.content.blueprints import build_blueprint_from_asset, validate_blueprint
