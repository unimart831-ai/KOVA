...
# Advanced scopes (pages_manage_posts, instagram_content_publish, etc.)
# require adding use cases in Meta Developer portal + App Review for public use
FB_SCOPES = "email,public_profile"

# Full scopes — enable once permissions are added in Meta Developer portal:
# FB_SCOPES = "email,public_profile,pages_show_list,pages_manage_posts,pages_read_engagement,instagram_basic,instagram_content_publish"
