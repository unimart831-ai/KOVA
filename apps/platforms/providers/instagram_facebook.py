...
# Combined scopes for both Facebook Page + Instagram
FB_SCOPES = "pages_show_list,pages_manage_posts,pages_read_engagement,instagram_basic,instagram_content_publish"
