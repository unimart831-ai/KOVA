...
from apps.products.commerce_autopilot import sanitize_product_name, unique_placeholder_name
from apps.products.image_utils import normalize_image_bytes
...
def launch_owner_snap(
    ...
    *,
    ...
    from apps.content.safety import check_uploaded_images_safe, record_content_safety_incident
