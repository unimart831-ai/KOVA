...
from apps.commerce.links.forms import (
    KovaFormForm,
    KovaLinkForm,
    KovaPageForm,
    PublicFormSubmissionForm,
)
from apps.commerce.links.models import (
    FormSubmission,
    KovaForm,
    KovaLink,
    KovaPage,
...
def public_page(request, slug):
    ...
    from apps.commerce.products.commerce_canonical import commerce_shop_redirect_path
    ...
    booking_url = ""
    if profile:
        from apps.commerce.products.commerce_seo import shop_index_url
...
def public_form_submit(request, slug, form_id):
    ...
    if form.is_valid():
        ...
        return redirect("public_page", slug=slug)
...
def public_link_click(request, slug, link_id):
    ...
    try:
        from apps.insight.analytics.revenue import record_touchpoint
