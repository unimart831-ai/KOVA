...
def process_nurture_steps():
    ...
    """
    from apps.commerce.leads.models import LeadActivity, LeadEnrollment, NurtureStep
...
def _execute_nurture_message_step(lead, step):
    ...
    from apps.commerce.leads.models import NurtureStep
    from apps.commerce.leads.nurture_router import NurtureChannel, route_nurture_step
...
def _ai_generate_nurture_email(lead, step, business_name):
    ...
    """
    try:
        from apps.create.agents.llm import generate, get_model_for_task
...
def score_all_leads():
    ...
    from apps.commerce.leads.scoring import score_and_update_lead
