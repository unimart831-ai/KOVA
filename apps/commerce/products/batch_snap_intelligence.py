...
def build_market_day_composition_prompt(stall_context: dict | None = None) -> str:
    ...
    from apps.commerce.products.photoroom_composition import build_market_day_composition_prompt as _compose_prompt
...
def build_stall_brand_lock(
    ...
    *,
    ...
    from apps.commerce.products.photoroom_plus import AI_BG_SEEDS
    ...
    if session_id:
        ...
        from apps.commerce.products.photoroom_brand_template import stable_ai_seed
...
def photoroom_template_from_stall_lock(brand_lock: dict | None):
    ...
    from apps.commerce.products.photoroom_brand_template import PhotoroomBrandTemplate, stable_ai_seed
...
def build_batch_identification_prompt(
    *,
    ...
    from apps.commerce.products.tasks import _build_vision_prompt
...
def build_batch_seed_idea(
    *,
    ...
    from apps.commerce.products.tasks import _build_seed_idea
