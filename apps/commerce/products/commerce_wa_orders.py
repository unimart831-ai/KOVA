...
from apps.commerce.products.commerce_social import resolve_shop_whatsapp
...
def _load_order_context(token_data: dict):
    ...
    if token_data.get("campaign_id"):
        ...
        if product is None:
            from apps.create.content.campaign_pages import _campaign_product
...
def _try_whatsapp_owner_alert(seller_user, body: str) -> None:
    ...
    if owner_phone:
        from apps.messaging.whatsapp.services import WhatsAppSendError, send_text_message
