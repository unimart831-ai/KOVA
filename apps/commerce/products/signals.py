...
def on_product_save(sender, instance, created, **kwargs):
    from apps.commerce.products.utils import invalidate_product_cache
...
def on_commerce_payment_completed(sender, instance, **kwargs):
    ...
    try:
        from apps.commerce.products.post_purchase import run_post_purchase
    ...
    try:
        ...
        from apps.commerce.products.commerce_wa_orders import notify_seller_payment_received
