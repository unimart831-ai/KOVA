...
def _link_public_href(link, page_slug: str) -> str:
    from apps.commerce.links.models import KovaLink
...
def build_unified_shop_footer(profile, user, request=None) -> dict:
    ...
    """
    from apps.commerce.links.forms import PublicFormSubmissionForm
    from apps.commerce.links.models import KovaLink
    from apps.commerce.products.storefront import shop_footer_data
