...
def _resolve_image_url(image_url: str) -> str | None:
    from apps.commerce.products.photoroom import _resolve_public_image_url
...
def generate_product_video(
    ...
    *,
    ...
    """
    from apps.commerce.products.photoroom import _api_key_headers
    from apps.commerce.products.photoroom_api import check_sandbox_quota, record_sandbox_call

    if user is not None:
        from apps.core.billing.video_credits import check_video_animate_limit
    ...
    try:
        ...
        if user is not None and product_id:
            from apps.core.billing.video_credits import record_video_animate
