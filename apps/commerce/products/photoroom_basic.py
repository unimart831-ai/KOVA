...
def photoroom_basic_segment(image_url: str, *, file_bytes: bytes | None = None) -> bytes | None:
    ...
    from apps.commerce.products.photoroom import _load_image_bytes, _resolve_public_image_url
...
def probe_basic_cutout_quality(
    ...
    *,
    ...
    from apps.commerce.products.photoroom_guard import validate_cutout_output
