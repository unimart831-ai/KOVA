...
from apps.commerce.products.photoroom_plus import EDIT_WITH_AI_PRODUCT_STAGING_BASE, photoroom_edit
...
def _polish_composite(composite_bytes: bytes, *, prompt: str, output_size: str) -> bytes | None:
    ...
    from apps.commerce.products.photoroom_plus import AI_BG_MODEL_HEADER
...
def compose_product_hero(
    ...
    *,
    ...
    if brand_template and brand_template.enabled:
        ...
        from apps.create.agents.graphics import _get_brand_palette
    ...
    if record_credits and profile_user:
        try:
            from apps.core.billing.visual_credits import record_studio_polish
