...
def scene_pack_priority_variant_ids(scene_pack: str, *, plan_tier: str) -> tuple[str, ...]:
    ...
    from apps.commerce.products.photoroom_plus import FOOD_SURFACE_VARIANT_IDS
    from apps.commerce.products.photoroom_plus import _plan_rank
...
def multi_angle_polish_enabled(plan_tier: str) -> bool:
    from apps.commerce.products.photoroom_preflight import GROWTH_PLUS_TIERS
...
def vertical_commerce_scenes(vertical: str, *, fallback_category: str) -> tuple[str, ...]:
    ...
    from apps.commerce.products.photoroom_plus import CATEGORY_COMMERCE_SCENES
...
def vertical_proof_variants(vertical: str, *, fallback_category: str) -> tuple[str, ...]:
    ...
    from apps.commerce.products.photoroom_plus import CATEGORY_PROOF_VARIANTS
...
def vertical_priority_variant_ids(
    ...
    *,
    ...
    from apps.commerce.products.photoroom_plus import PLUS_VARIANT_CATALOG, _plan_rank
