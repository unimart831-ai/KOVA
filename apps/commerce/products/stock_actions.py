...
def apply_stock_transition_actions(product, old_status, new_status):
    ...
    if new_status == Product.StockStatus.OUT_OF_STOCK and old_status != Product.StockStatus.OUT_OF_STOCK:
        try:
            from apps.commerce.products.models import StockAlert
            from apps.commerce.products.utils import pause_oos_scheduled_posts
        ...
        try:
            from apps.commerce.products.models import StockAlert
            from apps.commerce.products.utils import generate_restock_seed
