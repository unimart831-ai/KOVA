...
def check_stock_alerts():
    ...
    """
    from apps.commerce.products.models import Product, StockAlert
...
def create_product_carousel_posts(product_id: str, seed_id: str, key_features: list, analysis: dict | None = None):
    ...
    from apps.create.content.models import ContentSeed, Post
    from apps.create.media.carousel_renderer import generate_branded_carousel_urls
    from apps.core.platforms.models import SocialAccount
    from apps.commerce.products.commerce_autopilot import initial_commerce_post_status
    from apps.commerce.products.models import Product
    from apps.core.utils import fire_task
    ...
    from apps.commerce.products.platform_visuals import aspect_ratio_for, pick_platform_images

    product_image_pool = list(product.all_image_urls or [])

    for account in accounts:
        from apps.create.content.post_copy import build_commerce_caption
    ...
    if posts_created:
        from apps.create.content.campaign_bundle import content_types_from_seed
...
def create_product_reel_posts(product_id: str, seed_id: str, key_features: list):
    ...
    from apps.create.agents.models import AgentAction
    from apps.create.content.models import ContentSeed, Post
    from apps.create.content.tasks import _normalize_reel_image_source, compose_reel_video
    from apps.core.platforms.models import SocialAccount
    from apps.commerce.products.commerce_autopilot import initial_commerce_post_status
    from apps.commerce.products.models import Product
    ...
    def _product_reel_image_sources(product, *, platform: str = ""):
        from apps.commerce.products.platform_visuals import pick_platform_images
    ...
    for account in accounts:
        ...
        try:
            ...
            from apps.create.media.orchestrator import media_hints_for_reel_post
...
def create_catalog_showcase(user_id: str, source: str = "manual", seed_id: str = ""):
    ...
    from apps.create.agents.carousel import generate_catalog_showcase_carousel
    from apps.create.agents.models import AgentAction
    from apps.create.content.models import ContentSeed, Post
    from apps.create.content.tasks import compose_reel_video
    from apps.core.platforms.models import SocialAccount
    ...
    if source == "weekly":
        from apps.commerce.products.catalog_showcase import weekly_showcase_due
...
def quick_post_product_photo(product_id: str):
    ...
    from apps.create.agents.models import AgentAction
    from apps.create.content.models import Post
    from apps.create.content.tasks import _normalize_reel_image_source
    from apps.core.platforms.models import SocialAccount
    from apps.commerce.products.commerce_autopilot import initial_commerce_post_status, should_auto_publish_commerce
    ...
    posts_created = 0
    for account in accounts:
        from apps.create.content.post_copy import build_quick_post_caption
...
def reidentify_product_from_photo(product_id: str):
    ...
    from apps.create.agents.llm import analyze_image, parse_llm_json
    from apps.commerce.products.commerce_autopilot import apply_ai_detected_product_fields, is_placeholder_product_name
    from apps.commerce.products.models import Product
...
def expand_product_photo_set(
    ...
    *,
    ...
    from apps.create.agents.models import AgentAction
    from apps.core.billing.visual_credits import begin_studio_polish_session
    from apps.commerce.products.models import Product
    ...
    if analysis:
        from apps.commerce.products.scene_packs import auto_apply_scene_pack_from_analysis
    ...
    if result.get("variations_created", 0) > 0:
        try:
            from apps.create.content.product_visuals import refresh_product_polished_posts
...
def _fire_snap_carousel_reel_after_expand(product, *, seed_id, key_features, analysis, fire_task):
    ...
    from apps.create.content.models import ContentSeed
    from apps.core.platforms.models import SocialAccount
    from apps.create.media.orchestrator import plan_media_for_product
...
def snap_to_sell_analyze(
    ...
    """
    from apps.create.agents.llm import analyze_image, generate, parse_llm_json
    from apps.create.agents.models import AgentAction
    from apps.create.content.models import ContentSeed
    from apps.create.content.tasks import generate_from_seed
    from apps.core.platforms.models import SocialAccount
    ...
    from apps.commerce.products.product_copy import _profile_industry_label
    ...
    try:
        ...
        from apps.commerce.products.product_copy import build_snap_fallback_analysis

        analysis = build_snap_fallback_analysis(product, profile)

    # ── Step 2: Enrich the product with AI analysis ──────────────────
    renamed_fields = apply_ai_detected_product_fields(product, analysis)
    from apps.commerce.products.product_cta import uses_marketplace_cta
    ...
    from apps.commerce.products.photo_variations import is_studio_polish_mode
...
def snap_batch_process(session_id: str):
    ...
    for product in products:
        ...
        from apps.commerce.products.photo_variations import expand_product_photos
        from apps.commerce.products.scene_packs import store_product_scene_pack
...
def finalize_batch_snap_session(session_id: str):
    ...
    from apps.create.agents.models import AgentAction
    from apps.create.content.models import ContentSeed, Post
    from apps.create.content.tasks import compose_reel_video, generate_from_seed, _normalize_reel_image_source
    from apps.core.platforms.models import SocialAccount
    from apps.commerce.products.batch_snap_intelligence import (
    ...
    from apps.commerce.products.gallery_preferences import hero_image_url_override
    ...
    composition_hero_url = None
    from apps.commerce.products.photoroom_composition import compose_product_hero, composition_enabled
...
def process_restock_scan(scan_id: str):
    ...
    """
    from django.utils import timezone
    from apps.commerce.products.models import RestockScan, Product, StockUpdate, StockAlert
    from apps.create.content.models import ContentSeed
    from apps.create.agents.models import AgentAction
    ...
    try:
        ...
        for product_pk, quantity, item_name in matched_products:
            try:
                ...
                from apps.commerce.products.stock_actions import log_stock_change
...
def generate_product_video_task(product_id):
    from apps.commerce.products.models import Product
    from apps.commerce.products.photoroom_video import generate_product_reel_video
...
def generate_promo_image_task(product_id, trigger="new_product"):
    from apps.commerce.products.models import Product
    from apps.commerce.products.promo_engine import generate_promo_image as gen_promo
...
def generate_virtual_model_task(product_id):
    from apps.commerce.products.models import Product
    from apps.commerce.products.photoroom_virtual_models import generate_virtual_model_pack
