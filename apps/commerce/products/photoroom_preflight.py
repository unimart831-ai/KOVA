...
def should_run_photofix_for_commerce(*, commerce_source: str | None = None) -> bool:
    ...
    if not photofix_enabled():
        return False
    if commerce_source in SNAP_COMMERCE_SOURCES:
        return True
...
def assess_photo_quality(image_source: str, analysis: dict | None = None) -> PhotoQualityReport:
    ...
    from apps.commerce.products.photoroom import _download_bytes_for_preflight
...
def build_repair_plan(
    ...
    *,
    ...
    from apps.commerce.products.photoroom_api import uncertainty_is_high
