...
STUDIO_POLISH_TARGET_VARIANTS = env.int("STUDIO_POLISH_TARGET_VARIANTS", default=4)
PHOTOROOM_MIN_SCENE_VARIANTS = env.int("PHOTOROOM_MIN_SCENE_VARIANTS", default=4)
